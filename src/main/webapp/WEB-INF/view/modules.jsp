...
<script src="/CRM/js/ADMIN/modules.js"></script>
				...
				<div class="content-wrapper">
					<div class="row">
						...
						<!--  <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card" onclick="openMasterModule()"> -->
						  <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card" onclick="openMasterModule(${userId})">
			 			  <div class="card card-statistics">
								<div class="card-body">
									<div class="clearfix">
										<div class="float-left">
						...
						<!--  <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card" onclick="openCRMModule()"> -->
						  <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card" onclick="openCRMModule(${userId})">
					     <div class="card card-statistics">
								<div class="card-body">
									<div class="clearfix">
										<div class="float-left">
