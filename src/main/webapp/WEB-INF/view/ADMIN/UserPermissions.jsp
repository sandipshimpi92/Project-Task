...
<title>ERP Project | UserAccessPesmission</title>
<!-- plugins:css -->
...
<link rel="stylesheet"
	href="CommonFiles/vendors/iconfonts/mdi/css/materialdesignicons.min.css">
<link rel="stylesheet"
	href="CommonFiles/vendors/css/vendor.bundle.base.css">
<link rel="stylesheet"
	href="CommonFiles/vendors/css/vendor.bundle.addons.css">
...
<script src="Admin/js/userPermission.js"></script>
			...
			<div class="navbar-menu-wrapper d-flex align-items-center">
				<ul class="navbar-nav navbar-nav-left header-links d-md-flex">
					<li id="rotation"><a id="menu-toggle" data-toggle="offcanvas"><span
                       ...
                       <li><a class="nav-link"
						Style="position: fixed; left: 50px; top: 0px;"><img
							class="img-xs" src="CommonFiles/images/GrobizLogo.png"
							style="width: 130px; height: 30px;" alt="Profile image"> </a></li>
                       <li class="nav-item dropdown d-xl-inline-block"
						...
						<div class="dropdown-menu dropdown-menu-right navbar-dropdown"
							id="p" style="width: 350%; background-color: #e6e6e6">
...
<!--      <h3>A demonstration of how to access a Checkbox</h3>
                     Admin <input type="checkbox" onclick="myFunction1()">
                     Firm Details <input type="checkbox" id="myCheck">
                     Create Users <input type="checkbox" id="myCheck1">
                     User Permissions <input type="checkbox" id="myCheck2">
                     User Browse  <input type="checkbox" id="myCheck3">
                     
<script>
function myFunction1() {
var x = document.getElementById("myCheck");
var x1 = document.getElementById("myCheck1");
var x2 = document.getElementById("myCheck2");
var x3 = document.getElementById("myCheck3");
...
x3.checked = true;
 ...
 -->
		                   ...
		                   <div class="card-body">
                	<form class="form-sample" method="post" id="userPermissionForm">
						<p class="card-description dddd slatcolor"><span class="glyphicon glyphicon-triangle-bottom rotate"	onclick="myFunction('myDIV')"></span>&nbsp;User Department Access Permissions</p>
							<div id="myDIV">
							<div class="row">
								<div class="col-md-4">
									<div class="form-group row">
											<label class="col-sm-4 col-form-label"></label>
												<div class="col-sm-6">
													<input type="hidden" class="form-control" id="hide" name="hide" />
												</div>
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group row">
										<label class="col-sm-4 col-form-label">Select User :<span style="color: red; font-size: 123%">*</span>
										</label>
											<div class="col-sm-6">
												<select style="border-color: #c0c0c0;"
													class="form-control selectUser" id="selectUser" name="selectUser" onchange="getPermissionsOf()">
							...
							<div align="center">
								<label>Select Departments For Permission:</label>
						
							</div>
							<div id="allDeptChecks">
							</div>
							<div align="center">
								<button type="submit" class="btn btn-primary gmd-4" id="updatePermissions">Update Access</button>
							</div>
							</div>
					</form>
                </div>
							...
							<!-- 	<div class="card-body">
									<form class="form-sample" method="post" id="userPermissionForm">
										<p class="card-description dddd slatcolor">
											<span class="glyphicon glyphicon-triangle-bottom rotate"
												onclick="myFunction('myDIV')"></span>&nbsp;User Department
											Access Permissions
										</p>
										<div id="myDIV">
											<div class="row">
												<div class="col-md-4">
													<div class="form-group row">
														<label class="col-sm-4 col-form-label"></label>
														<div class="col-sm-6">
															<input type="hidden" class="form-control" id="hide"
																name="hide" />
														</div>
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group row">
														<label class="col-sm-4 col-form-label">Select User
															:<span style="color: red; font-size: 123%">*</span>
														</label>
														<div class="col-sm-6">
															<select style="border-color: #c0c0c0;"
																class="form-control selectUser" id="selectUser"
																name="selectUser" onchange="getPermissionsOf()">
																<option value="none">---select---</option>
															</select>
														</div>
													</div>
										...
										<!-- 	<div align="center">
											  ...
											  -->
											   ...
											   <%--  <c:choose>
                                               <c:when test="${(nm == '22')||(nm1 == '22')||(nm2 == '22')||(nm3 == '22')||(nm4 == '22')||(nm5 == '22')||(nm6 == '22')||(nm7 == '22')||(nm8 == '22')||(nm9 == '22')||(nm10 == '22')||(nm11 == '22')||(nm12 == '22')||(nm13 == '22')||(nm14 == '22')||(nm15 == '22')||(nm16 == '22')||(nm17 == '22')||(nm18 == '22')||(nm19 == '22')||(nm20 == '22')||(nm21 == '22')||(nm22 == '22')||(nm23 == '22')||(nm24 == '22')||(nm25 == '22')||(nm26 == '22')||(nm27 == '22')||(nm28 == '22')||(nm29 == '22')||(nm30 == '22')||(nm31 == '22')||(nm32 == '22')||(nm33 == '22')||(nm34 == '22')||(nm35 == '22')||(nm36 == '22')||(nm37 == '22')||(nm38 == '22')||(nm39 == '22')||(nm40 == '22')||(nm41 == '22')||(nm42 == '22')||(nm43 == '22')||(nm44 == '22')||(nm45 == '22')||(nm46 == '22')||(nm47 == '22')||(nm48 == '22')||(nm49 == '22')||(nm50 == '22')||(nm51 == '22')||(nm52 == '22')||(nm53 == '22')||(nm54 == '22')||(nm55 == '22')||(nm56 == '22')||(nm57 == '22')||(nm58 == '22')||(nm59 == '22')||(nm60 == '22')||(nm61 == '22')||(nm62 == '22')||(nm63 == '22')||(nm64 == '22')||(nm65 == '22')||(nm66 == '22')||(nm67 == '22')||(nm68 == '22')||(nm69 == '22')||(nm70 == '22')||(nm71 == '22')||(nm72 == '22')||(nm73 == '22')||(nm74 == '22')||(nm75 == '22')||(nm76 == '22')||(nm77 == '22')||(nm78 == '22')||(nm79 == '22')||(nm80 == '22')||(nm81 == '22')||(nm82 == '22')||(nm83 == '22')||(nm84 == '22')||(nm85 == '22')||(nm86 == '22')||(nm87 == '22')||(nm88 == '22')||(nm89 == '22')||(nm90 == '22')||(nm91 == '22')||(nm92 == '22')||(nm93 == '22')||(nm94 == '22')||(nm95 == '22')||(nm96 == '22')||(nm97 == '22')||(nm98 == '22')||(nm99 == '22')||(nm100 == '22')||(nm101 == '22')||(nm102 == '22')||(nm103 == '22')||(nm104 == '22')||(nm105 == '22')||(nm106 == '22')||(nm107 == '22')||(nm108 == '22')||(nm109 == '22')||(nm110 == '22')||(nm111 == '22')||(nm112 == '22')||(nm113 == '22')||(nm114 == '22')||(nm115 == '22')||(nm116 == '22')||(nm117 == '22')||(nm118 == '22')||(nm119 == '22')||(nm120 == '22')||(nm121 == '22')||(nm122 == '22')||(nm123 == '22')||(nm124 == '22')||(nm125 == '22')||(nm126 == '22')||(nm127 == '22')||(nm128 == '22')||(nm129 == '22')||(nm130 == '22')||(nm131 == '22')||(nm132 == '22')||(nm133 == '22')||(nm134 == '22')||(nm135 == '22')||(nm136 == '22')||(nm137 == '22')||(nm138 == '22')||(nm139 == '22')||(nm140 == '22')||(nm141 == '22')||(nm142 == '22')||(nm143 == '22')||(nm144 == '22')||(nm145 == '22')||(nm146 == '22')||(nm147 == '22')||(nm148 == '22')||(nm149 == '22')||(nm150 == '22')||(nm151 == '22')||(nm152 == '22')}">
                                               <button type="submit" class="btn btn-primary gmd-4" id="updatePermissions">Update Access</button>
	                                           </c:when>
                                               <c:otherwise>
                                               <button type="submit" <c:out value="disabled='disabled'"/> class="btn btn-primary gmd-4">Update Access</button>
                                               </c:otherwise>
                                               </c:choose> --%>
                                  <!--           </div>
										</div>
								...
								<%-- 	
									...
									<form class="form-sample" method="post" id="userPermissionForm1">
										<p class="card-description dddd slatcolor">
											<span class="glyphicon glyphicon-triangle-bottom rotate"
												onclick="myFunction('myDIV')"></span>&nbsp;User CRM
											Access Permissions
										</p>
										<div id="myDIV">
											<div class="row">
												...
												<div class="col-md-4">
													<div class="form-group row">
														...
														<div class="col-sm-6">
															<select style="border-color: #c0c0c0;"
																class="form-control selectUser1" id="selectUser1"
																name="selectUser1" onchange="getPermissionsOf1()">
																<option value="none">---select---</option>
															</select>
														</div>
													</div>
											...
											<div id="allDeptChecks1"></div>
											<div align="center">
											   <button type="submit" class="btn btn-primary gmd-4" id="updatePermissions1">Update Access</button>
  ...
  <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    ...
    <div class="container-fluid page-body-wrapper" id="wrapper">
     	...
     	<div id="sidebar-wrapper">
				<nav class=" gmd-5 sidebar sidebar-offcanvas" id="sidebar ">
					<ul class="nav" id="accordion">
						<li class="nav-item"><a class="nav-link" href="http://localhost:8080/Master/Modules?u=<%=username%>&word=<%=password%>&firm=<%=firmsUsername%>"><i
