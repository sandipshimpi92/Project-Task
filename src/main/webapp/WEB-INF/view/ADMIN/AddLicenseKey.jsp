...
<head>
  ...
  <title>ERP Project | Admin | LicenseKey</title>
  <!-- plugins:css -->
  
<%@ taglib uri="http://www.springframework.org/tags" prefix="spring"%>
<spring:url value="/AdminDashboard" var="admindashboardurl" />
<spring:url value="/CRMDashboard?s=<%=userId%>" var="dashboardurl" />
<spring:url value="/MasterDashboard" var="dashboardurl" />
<spring:url context="/Master" value="/Modules" var="modules" />
<%-- <spring:url value="/Modules" var="modules" /> --%>
...
<spring:url value="/AddLicenseKey" var="addLicenseKeyUrl" />
  ...
  <!--advanced data table js end here  -->
   ...
   <script src="/Admin/js/AddLicenseKey.js"></script>
    ...
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="navbar-menu-wrapper d-flex align-items-center">
        ...
        <li id="rotation"><a href="#" id="menu-toggle" data-toggle="offcanvas"><span
				Style="position: fixed; left: 12px; top: 19px; color: red;" class="mdi mdi-menu"></span></a></li>
		<%-- <li class="nav-item"><a href="#" class="nav-link"
				Style="position: fixed; left: 35px; top: 3px; color: white; font-size: 22px;"><%=firmsName%></a></li> --%>
		...
		<li class="nav-item dropdown d-xl-inline-block"
				...
				<a class="nav-link dropdown-toggle" href="#p"
					data-toggle="dropdown" aria-expanded="false"> <img class="img-xs rounded-circle"
					src="CommonFiles/images/user-laptop-512.png"
					style="background-color: white;" alt="Profile image">
				</a>
			<div class="dropdown-menu dropdown-menu-right navbar-dropdown" id="p" style="width: 350%; background-color: #e6e6e6">
				<div class="well" style="background: #fff;">
					<div class="media text-center">
						...
						<div class="media-body">
							...
							<br>
							<h4 style="width: 100%" class="media-heading">Welcome to,</h4>
							<h5><%=firmsName%></h5>
						</div>
					</div>
				</div>
		...
		<li class="nav-item dropdown"
				Style="position: fixed; right: 0px; top: 4px; color: white;"><a class="nav-link count-indicator dropdown-toggle"
				id="notificationDropdown" href="#" data-toggle="dropdown"> <i
				class="mdi mdi-bell"></i> <span class="count">4</span></a>
		</li>
        </ul>
      </div>
    </nav>
      ...
      <div class="main-panel">
					...
					<div class="row">
						<div class="col-12 grid-margin">
							<div class="card gmd-5">
								<div class="card-body">
									<form class="form-sample" id="serializeLicenseKey">
										<p class="card-description slatcolor">
											<span onclick="myFunction('myDIV1')" class="glyphicon glyphicon-triangle-bottom rotate"></span>
									License Key Registration
											...
											<div>
												<div class="col-md-1">
													<div class="form-group row">
														<div class="col-sm-12">
															<label class="col-sm-12 col-form-label" style="font-size: 12px; font-weight: normal;">License Key :<span style="color:red; font-size:123%">*</span></label>
														</div>
													</div>
												</div>
												<div class="col-md-2">
													<div class="form-group row">
														<div class="col-sm-12">
															<input type="text" class="form-control" id="first" maxlength="5" name="first" onkeypress ="jump(this)" style="text-transform:uppercase" required="required"/>
														</div>
													</div>
												</div>
												<div class="col-md-2" >
													<div class="form-group row">													
														<div class="col-sm-12">
															<input type="text" class="form-control" id="second" maxlength="5" name="second" onkeypress="jump(this)" style="text-transform:uppercase" required="required"/>
														</div>
													</div>
												</div>
												<div class="col-md-2" >
													<div class="form-group row">													
														<div class="col-sm-12">
															<input type="text" class="form-control" id="third" maxlength="5" name="third" onkeypress ="jump(this)" style="text-transform:uppercase"required="required"/>
														</div>
													</div>
												</div>
												<div class="col-md-2" >
													<div class="form-group row">													
														<div class="col-sm-12">
															<input type="text" class="form-control" id="fourth" maxlength="5" name="fourth" onkeypress ="jump(this)" style="text-transform:uppercase" required="required"/>
														</div>
													</div>
												</div>
												<div class="col-md-2" >
													<div class="form-group row">
														<div class="col-sm-12">
															<input type="text" class="form-control" id="fifth" maxlength="4" name="fifth" onkeyup ="jum(this)" style="text-transform:uppercase" required="required" />
														</div>
													</div>
												</div>
												<div id="glypIcon">
										...
										<div style="margin-left: 40%">
											 <c:choose>
											 <c:when test="${(nm == '21')||(nm1 == '21')||(nm2 == '21')||(nm3 == '21')||(nm4 == '21')||(nm5 == '21')||(nm6 == '21')||(nm7 == '21')||(nm8 == '21')||(nm9 == '21')||(nm10 == '21')||(nm11 == '21')||(nm12 == '21')||(nm13 == '21')||(nm14 == '21')||(nm15 == '21')||(nm16 == '21')||(nm17 == '21')||(nm18 == '21')||(nm19 == '21')||(nm20 == '21')||(nm21 == '21')||(nm22 == '21')||(nm23 == '21')||(nm24 == '21')||(nm25 == '21')||(nm26 == '21')||(nm27 == '21')||(nm28 == '21')||(nm29 == '21')||(nm30 == '21')||(nm31 == '21')||(nm32 == '21')||(nm33 == '21')||(nm34 == '21')||(nm35 == '21')||(nm36 == '21')||(nm37 == '21')||(nm38 == '21')||(nm39 == '21')||(nm40 == '21')||(nm41 == '21')||(nm42 == '21')||(nm43 == '21')||(nm44 == '21')||(nm45 == '21')||(nm46 == '21')||(nm47 == '21')||(nm48 == '21')||(nm49 == '21')||(nm50 == '21')||(nm51 == '21')||(nm52 == '21')||(nm53 == '21')||(nm54 == '21')||(nm55 == '21')||(nm56 == '21')||(nm57 == '21')||(nm58 == '21')||(nm59 == '21')||(nm60 == '21')||(nm61 == '21')||(nm62 == '21')||(nm63 == '21')||(nm64 == '21')||(nm65 == '21')||(nm66 == '21')||(nm67 == '21')||(nm68 == '21')||(nm69 == '21')||(nm70 == '21')||(nm71 == '21')||(nm72 == '21')||(nm73 == '21')||(nm74 == '21')||(nm75 == '21')||(nm76 == '21')||(nm77 == '21')||(nm78 == '21')||(nm79 == '21')||(nm80 == '21')||(nm81 == '21')||(nm82 == '21')||(nm83 == '21')||(nm84 == '21')||(nm85 == '21')||(nm86 == '21')||(nm87 == '21')||(nm88 == '21')||(nm89 == '21')||(nm90 == '21')||(nm91 == '21')||(nm92 == '21')||(nm93 == '21')||(nm94 == '21')||(nm95 == '21')||(nm96 == '21')||(nm97 == '21')||(nm98 == '21')||(nm99 == '21')||(nm100 == '21')||(nm101 == '21')||(nm102 == '21')||(nm103 == '21')||(nm104 == '21')||(nm105 == '21')||(nm106 == '21')||(nm107 == '21')||(nm108 == '21')||(nm109 == '21')||(nm110 == '21')||(nm111 == '21')||(nm112 == '21')||(nm113 == '21')||(nm114 == '21')||(nm115 == '21')||(nm116 == '21')||(nm117 == '21')||(nm118 == '21')||(nm119 == '21')||(nm120 == '21')||(nm121 == '21')||(nm122 == '21')||(nm123 == '21')||(nm124 == '21')||(nm125 == '21')||(nm126 == '21')||(nm127 == '21')||(nm128 == '21')||(nm129 == '21')||(nm130 == '21')||(nm131 == '21')||(nm132 == '21')||(nm133 == '21')||(nm134 == '21')||(nm135 == '21')||(nm136 == '21')||(nm137 == '21')||(nm138 == '21')||(nm139 == '21')||(nm140 == '21')||(nm141 == '21')||(nm142 == '21')||(nm143 == '21')||(nm144 == '21')||(nm145 == '21')||(nm146 == '21')||(nm147 == '21')||(nm148 == '21')||(nm149 == '21')||(nm150 == '21')||(nm151 == '21')||(nm152 == '21')}">
										     <button type="submit" id="saveB"class="btn btn-primary gmd-4" >
												<span class="fa fa-floppy-o"></span> &nbsp;Save
											</button>
											</c:when>
                                               <c:otherwise>
                                                <button type="submit" <c:out value="disabled='disabled'"/> class="btn btn-primary gmd-4" >
												<span class="fa fa-floppy-o"></span> &nbsp;Save
											    </button> 
	                                            </c:otherwise>
                                              </c:choose>
											<button type="button"class="btn btn-primary gmd-4" onclick="location.reload(true);"><span  class="fa fa-refresh" ></span>&nbsp;Refresh</button>
										</div>
										</div><br>
										<c:if test="${(nm == '20')||(nm1 == '20')||(nm2 == '20')||(nm3 == '20')||(nm4 == '20')||(nm5 == '20')||(nm6 == '20')||(nm7 == '20')||(nm8 == '20')||(nm9 == '20')||(nm10 == '20')||(nm11 == '20')||(nm12 == '20')||(nm13 == '20')||(nm14 == '20')||(nm15 == '20')||(nm16 == '20')||(nm17 == '20')||(nm18 == '20')||(nm19 == '20')||(nm20 == '20')||(nm21 == '20')||(nm22 == '20')||(nm23 == '20')||(nm24 == '20')||(nm25 == '20')||(nm26 == '20')||(nm27 == '20')||(nm28 == '20')||(nm29 == '20')||(nm30 == '20')||(nm31 == '20')||(nm32 == '20')||(nm33 == '20')||(nm34 == '20')||(nm35 == '20')||(nm36 == '20')||(nm37 == '20')||(nm38 == '20')||(nm39 == '20')||(nm40 == '20')||(nm41 == '20')||(nm42 == '20')||(nm43 == '20')||(nm44 == '20')||(nm45 == '20')||(nm46 == '20')||(nm47 == '20')||(nm48 == '20')||(nm49 == '20')||(nm50 == '20')||(nm51 == '20')||(nm52 == '20')||(nm53 == '20')||(nm54 == '20')||(nm55 == '20')||(nm56 == '20')||(nm57 == '20')||(nm58 == '20')||(nm59 == '20')||(nm60 == '20')||(nm61 == '20')||(nm62 == '20')||(nm63 == '20')||(nm64 == '20')||(nm65 == '20')||(nm66 == '20')||(nm67 == '20')||(nm68 == '20')||(nm69 == '20')||(nm70 == '20')||(nm71 == '20')||(nm72 == '20')||(nm73 == '20')||(nm74 == '20')||(nm75 == '20')||(nm76 == '20')||(nm77 == '20')||(nm78 == '20')||(nm79 == '20')||(nm80 == '20')||(nm81 == '20')||(nm82 == '20')||(nm83 == '20')||(nm84 == '20')||(nm85 == '20')||(nm86 == '20')||(nm87 == '20')||(nm88 == '20')||(nm89 == '20')||(nm90 == '20')||(nm91 == '20')||(nm92 == '20')||(nm93 == '20')||(nm94 == '20')||(nm95 == '20')||(nm96 == '20')||(nm97 == '20')||(nm98 == '20')||(nm99 == '20')||(nm100 == '20')||(nm101 == '20')||(nm102 == '20')||(nm103 == '20')||(nm104 == '20')||(nm105 == '20')||(nm106 == '20')||(nm107 == '20')||(nm108 == '20')||(nm109 == '20')||(nm110 == '20')||(nm111 == '20')||(nm112 == '20')||(nm113 == '20')||(nm114 == '20')||(nm115 == '20')||(nm116 == '20')||(nm117 == '20')||(nm118 == '20')||(nm119 == '20')||(nm120 == '20')||(nm121 == '20')||(nm122 == '20')||(nm123 == '20')||(nm124 == '20')||(nm125 == '20')||(nm126 == '20')||(nm127 == '20')||(nm128 == '20')||(nm129 == '20')||(nm130 == '20')||(nm131 == '20')||(nm132 == '20')||(nm133 == '20')||(nm134 == '20')||(nm135 == '20')||(nm136 == '20')||(nm137 == '20')||(nm138 == '20')||(nm139 == '20')||(nm140 == '20')||(nm141 == '20')||(nm142 == '20')||(nm143 == '20')||(nm144 == '20')||(nm145 == '20')||(nm146 == '20')||(nm147 == '20')||(nm148 == '20')||(nm149 == '20')||(nm150 == '20')||(nm151 == '20')||(nm152 == '20')}">
										<p class="card-description slatcolor">
											<span onclick="myFunction('myDIV')"	class="glyphicon glyphicon-triangle-right rotate1"></span>
											License key Details
										</p>
										<div id="myDIV" style="display: none;">
											
											    <div class="row table-responsive">
													<div class="container" id="LicenseKeyDetails">
											    </div> 
										 	</div>								
										</div>
        ...
        <!-- change password bootsrap code -->
					...
					<div class="modal-dialog modal-dialog-centered">
							<div class="modal-content" style="background-color: white;width: 80%;margin-left: 12%">
							<!-- Modal Header -->
							...
							<div class="modal-body" style="margin-left: 14%">
								...
								<div class="form-group">
									<label >Old Password:</label> <input type="password"
										class="form-control" id="password" name="oldpassword" style="border-color: #c0c0c0;width: 80%" required/>
								</div>
								<div class="form-group">
									<label >New Password :</label>
									 <input type="password"
										class="form-control" id="newPassword" name="newPassword" style="border-color: #c0c0c0;width: 80%" required/>
								</div>
								<div class="form-group">
									<label >Confirm New Password :</label> <input
										type="password" class="form-control" name="confirmPassword" id="confirmPassword" style="border-color: #c0c0c0;width: 80%" required/>
								</div>
							</div>

							<!-- Modal footer -->
							<div class="modal-footer" align="center">
									<button type="button" class="btn btn-primary gmd-4" onclick="saveNewPassword()">
										<span class="fa fa-floppy-o"></span> &nbsp;Save
									</button>
									<button class="btn btn-primary gmd-4" data-dismiss="modal">Cancel</button>
							</div>
						</div>
					</div>
					</div>
   ...
   <footer class="footer">
          <div class="container-fluid clearfix">
            <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © 2019
              <a href="http://www.edzeal.com/" target="_blank">Edzeal Technologies LLP</a>. All rights reserved.</span>
          </div>
        </footer>
        <!-- partial -->
      </div>
